...
namespace Apigee\Edge\CodingStandards\Sniffs\Commenting;

use PHP_CodeSniffer\Files\File;
use PHP_CodeSniffer\Sniffs\Sniff;

/**
 * Ensures copyright in header comment.
 */
class CopyrightSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        } elseif (false === $commentStart || T_DOC_COMMENT_OPEN_TAG !== $tokens[$commentStart]['code']) {
